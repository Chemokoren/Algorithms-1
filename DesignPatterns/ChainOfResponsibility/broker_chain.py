...
class Creature:
    ...
    def __init__(self, game, name, attack, defense):
        ...
        self.inital_attack = attack
        self.name = name
        self.game = game
        
    @property
    def attack(self):
        q = Query(self.name, WhatToQuery.ATTACK, self.inital_attack)
        self.game.perform_query(self, q)
        return q.value
    
    @property
    def defense(self):
        q = Query(self.name, WhatToQuery.DEFENSE, self.inital_attack)
        self.game.perform_query(self, q)
        return q.value
...
if __name__=='__main__':
    ...
    with DoubleAttackModifier(game, goblin):
        print(goblin)
        with IncreaseDefenceModifier(game, goblin):
            print(goblin)
    print(goblin)