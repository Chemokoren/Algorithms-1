...
A decorator facilitates the addition of behaviours to individual objects without inheriting 
from them.
...
- Python's fuctional decorators wrap fuctions; no direct relation to the GoF Decorator
pattern
"""
