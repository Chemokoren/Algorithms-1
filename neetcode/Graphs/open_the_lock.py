...
turn '9' to be '0' or '0' to be '9'. Each move consists of turning one wheen one slot.
...
minimum number of turns required to open the lock, or -1 if it is impossible.

Example 1:
input: deadends =["0201","0101","0102","1212","2002"], target ="0202"
Output: 6
Explanation:
A sequence of valid moves would be "0000" ->"1000"-> "1100"->"1200"->"1202"->"0202".
