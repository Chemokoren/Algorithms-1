"""
Number of ways to Rearrange Sticks withK sticks visible
...
- For example, if the sticks are arranged [1,3,2,5,4], then the sticks with lengths 1,3, and 5 are visible 
from the left.
...
class Solution:
    ...
    # bottom-up solution
    def rearrangeSticksBottomUp(self, n: int, k:int)->int:
        dp ={(1,1): 1}
...
sol = Solution()
print("Top-Down sol:",sol.rearrangeSticks(n, k))
print("Bottom up sol: ", sol.rearrangeSticksBottomUp(n, k))