...
You may assume all tickets form at least one valid itinerary. You must use all tickets
once and only once.
...
Input: tickes =[["MUC","LHR"], ["JFK","MUC"], ["SFO","SJC"],["LHR","SFO"]]
...
sol = Solution()
print("Expected:",sol.find_itinerary([["MUC","LHR"], ["JFK","MUC"], ["SFO","SJC"],["LHR","SFO"]]))