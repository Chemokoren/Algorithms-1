...
Have the function BitmapHoles(strArr)take the array of strings stored in strArr, which will be a
2D matrix of 0 and 1's, and determine how many holes, or contiguous regions of 0's, exist in the
matrix. A contiguous region is one where there is a connected group of 0's going in one or more
of four directions: up,down, left or right. For example: if strArr is 
...
For the input above, your program should return 2 because there are two seperate contiguous 
...
print("Expected:3, Actual", BitmapHoles(["01111", "01101", "00011", "11110"]))
print("Expected:2, Actual", BitmapHoles(["1011", "0010"]))