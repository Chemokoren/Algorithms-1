"""
program to convert a binary tree to a CLL
"""
...
# Function converts a tree to a CLL and then returns the head of the LL
def bTreeToCList(root):
    ...
    # Make a CLL of single node or root.To do so, make the right and left pointers
    # of this node to point to itself.
