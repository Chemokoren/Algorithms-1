...
The above approaches work well when there is a single rotation required. The approaches also modify the
original array. To handle multiple queries of array rotation, we use a temp array of size 2n and quickly 
handle rotations.
...
To find the starting address of rotation takes O(1) time. It is printing the elements that take O(n) time.
