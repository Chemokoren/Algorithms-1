...
def pairsInSortedRotated(arr, n, x):
    ...
    # Find the pivot element- is largest element of array.
    for i in range(n):
        if arr[i] > arr[i + 1]:
            break
    ...
    while (l != r):
        ...
        if arr[l] + arr[r] == x:
            ...
            # This condition is required to be checked, otherwise l and r will
            # cross each other and loop will never terminate.
            if l == (r - 1 + n) % n:
                return cnt
