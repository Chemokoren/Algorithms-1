...
def tryUpdateLongestStringChain(currentString, smallerString, stringChins):
    smallerStringChainLength =stringChins[smallerString]["maxChainLength"]
    currentStringChainLength =stringChins[currentString]["maxChainLength"]
    if smallerStringChainLength + 1 > currentStringChainLength:
        stringChins[currentString]["maxChainLength"] =smallerStringChainLength +1
        stringChins[currentString]["nextString"] =smallerString
