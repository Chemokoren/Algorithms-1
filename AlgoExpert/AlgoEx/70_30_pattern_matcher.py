...
def patternMatcher(pattern, string):
    ...
    counts ={"x":0, "y":0}
    firstYPos = getCountsAndFirsYPos(newPattern,counts)
    if counts["y"] != 0:
...
def getCountsAndFirsYPos(pattern, counts):
    firstYPos = None
...
my_pattern ="xxyxxy"
my_string ="gogopowerrangergogopowerranger"

print(patternMatcher(my_pattern,my_string))