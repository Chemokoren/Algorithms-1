...
-search(), which searches for the presence of a node in the tree, and 
...
class BinaryTree(object):
    ...
    def search(self, find_val):
        ...
        False otherwise.
        '''
        return self.preorder_search_updated(self.root, find_val)
    ...
    def preorder_search_updated(self, start, find_val):
        if start:
            if start.value == find_val:
                return True
            else:
                return self.preorder_search_updated(start.left, find_val) or self.preorder_search_updated(start.right, find_val)
        return False
    ...
    def preorder_print_updated(self, start, traversal):
        if start:
            traversal += (str(start.value)+"-")
            traversal = self.preorder_print_updated(start.left, traversal)
            traversal = self.preorder_print_updated(start.right, traversal)
        return traversal
